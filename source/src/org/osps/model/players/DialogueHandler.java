...
/*		if (c.dialogue().isActive()) {
		...
		case 12345:
			c.getDH().sendOption4("Main Rune (SS)", "Main Rune (Mace/SS)", "Main Granite (Mace)", "Cancel");
			c.dialogueAction = 12345;
			break;
			
		case 12346:
			c.getDH().sendOption4("Pure Melee", "Pure Melee & Range", "Pure Tribrid", "Cancel");
			c.dialogueAction = 12346;
			break;
			
		case 12347:
			c.getDH().sendOption4("Hybrid (4 way)", "Hybrid (5 way)", "Hybrid (6 way)", "Cancel");
			c.dialogueAction = 12347;
			break;
		...
		case 12350:
			c.getDH().sendOption2("Tank", "Cancel");
			c.dialogueAction = 12350;
			break;
			
		case 12351:
			c.getDH().sendOption4("Melee", "Range", "Magic", "Cancel");
		 ...
		 */
		case 1610:
			sendNpcChat2("Hello " + c.playerName + ", and welcome to Pkers.Ca ,", "Would you like to take the tutorial again?", 306, "Otto godblessed");
			c.nextChat = 1611;
		break;
		case 1611:
			sendOption2("Yes.", "No, sorry not right now!");
			...
			break;
	case 1600:
		sendNpcChat3("Hello " + c.playerName + ", and welcome to Pkers.Ca ,", "I'll quickly give you a few brief tips",
					 "in order to better your stay here at Pkers.Ca .", 306, "Pkers.Ca  Guide");
		c.nextChat = 1602;
	break;
	case 1602:
		sendNpcChat3("We have 2 home areas,", "one in zeah and the other in edgeville.", 
					 "Use which ever you like for your convenience.", 306, "Pkers.Ca  Guide");
	...
	case 6670:
		...
		break;
	case 1603:
		sendNpcChat2("This is our home, here you can find shops,", "banks, slayer masters, and everything else you would need!", 306, "Pkers.Ca  Guide");
		c.nextChat = 1604;
	break;
	case 1604:
		sendNpcChat3("This is the skilling area", "where you can get your skills up and earn pk points", 
					 "you can even get skilling pets if you're lucky.", 306, "Pkers.Ca Guide");
		c.getPA().movePlayer(1803, 3788, 0);
		c.nextChat = 1605;
	break;
	case 1605:
		sendNpcChat2("We have a huge array of interesting bosses,", "which includes full Cerberus and Abyssal sire", 306, "Pkers.Ca Guide");
		c.getPA().movePlayer(1240, 1245, 0);
		c.nextChat = 1606;
	break;
	case 1606:
		sendNpcChat2("PK Points is our currency of choice,", "and its obtainable via bossing,skilling,and pking.", 306, "Pkers.Ca Guide");
		c.nextChat = 1607;
	break;
	case 1607:
		sendNpcChat3("The most creative aspect of our server is", "the new hunger games minigame that we",
					 "spent countless hours creating.", 306, "Pkers.Ca Guide");
	...
	break;
		...
		case 3301:
			...
			break;
		case 3325:
			c.getDH().sendOption4("KBD Entrance @red@(Wild)", "Chaos Elemental @red@(Wild)", "Godwars"/*, "Barrelchest @red@(Lvl 20+ Wild)"*/,
					"@blu@Next Page");
			c.teleAction = 3;
			c.dialogueAction = -1;
			break;
		...
		case 4006:
			sendOption3(
					"Redeem for 30000 PK Points.",
					"Redeem for 250 Donator points.",
					"No. I don't wanna use this.");
		...
		case 4007:
			sendOption3(
					"Redeem for 100000 PK Points.",
					"Redeem for 1000 Donator points.",
					"No. I don't wanna use this.");
		...
		case 4004:
			...
			break;
//		case 4070:
//			sendItemChat3("","You can make out some faded words on the ancient", "parchment. It appears to be an archaic invocation of the ", "gods! What would you like to learn?", 21034, 200);
//			//c.dialogueAction = 4007;
//			c.nextChat = 4080;
//			break;
//		case 4080:
//			sendOption4("Rigour","Augury", "Preserve", "Cancel");
//			c.dialogueAction = 4080;
//			c.nextChat = 0;
//			break;
		case 4071:
			sendItemChat3("","You can make out some faded words on the ancient", "parchment. It appears to be an archaic invocation of the ", "gods! What would you like to learn?", 21034, 200);
			...
			break;
		case 4072:
			sendOption2("Preserve", "Cancel");
			c.dialogueAction = 4072;
			c.nextChat = 0;
			break;
			//
		case 4073:
			...
			break;
		case 4074:
			sendOption2("Rigour", "Cancel");
			c.dialogueAction = 4074;
			c.nextChat = 0;
			break;
			//
		case 4075:
			...
			break;
		case 4076:
			sendOption2("Augury", "Cancel");
			c.dialogueAction = 4076;
			c.nextChat = 0;
			break;
		case 2244:
	...
	/*	case 599:
		...
		case 3601:
			...
			break;
		case 3607:
			sendNpcChat1("You currently have "+c.pkp+" PK points.", c.talkingNpc, "Mazchna");
			c.dialogueAction = 39;
			c.nextChat = 0;
		break;
		case 3608:
			sendOption2("Range Weapons", "Range Armor");
			c.dialogueAction = 3608;
		break;	
		case 3609:
			sendOption2("Weapons", "Main armor");
			c.dialogueAction = 3609;
		break;	
		case 3610:
			sendOption2("Wilderness Zones", "Safe Zones");
			c.dialogueAction = 3610;	
		break;
		case 3611:
			c.getDH().sendOption5("East Dragons @red@[20]", "Brid Zone @blu@[bank]", "Varrock @blu@[bank]", "Mage Bank @blu@[bank]", "- back -");
			c.dialogueAction = 3611;
		break;
		case 3612:
			c.getDH().sendOption4("Fun Pk @blu@[Safe]", "F2P Pking @blu@[Safe]", "Castle Wars @blu@[Safe]", "- back- ");
			c.dialogueAction = 3612;
		break;
		case 3613:
			c.getDH().sendOption2("Donator Store", "Donator Point Store");
			c.dialogueAction = 3613;
		break;
		case 3614:
			c.getDH().sendOption2("Free Items!", "Cancel");
			c.dialogueAction = 3614;
		break;
		case 3615:
			sendOption2("Magic Accessories", "Magic Armor");
			c.dialogueAction = 3615;
		break;	
		case 3616:
			sendOption3("Pure Armor", "Food and Potions", "Amulet and Rings");
			c.dialogueAction = 3616;
		break;	
		case 3617:
			sendOption2("F2P Items", "Costumes");
			c.dialogueAction = 3617;
		break;	
		}
