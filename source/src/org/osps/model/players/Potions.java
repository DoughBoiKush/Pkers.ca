...
public class Potions {
	...
	public void handlePotion(int itemId, int slot) {
		...
		if (c.potionTimer.elapsed(1200)) {
			...
			case 3030:
				...
				break;
			case 10925:
				drinkSanfewPot(itemId, 10927, slot, true); // sanfew serums
				curePoison(0);
				break;
			case 10927:
				drinkSanfewPot(itemId, 10929, slot, true);
				curePoison(0);
				break;
			case 10929:
				drinkSanfewPot(itemId, 10931, slot, true);
				curePoison(0);
				break;
			case 10931:
				drinkSanfewPot(itemId, 229, slot, true);
				curePoison(0);
				break;
			case 2434:
	...
	public void drinkSanfewPot(int itemId, int replaceItem, int slot, boolean rest) {
		c.animation(829);
		c.playerItems[slot] = replaceItem + 1;
		c.getItems().resetItems(3214);
		c.playerLevel[5] += 8 + (Player.getLevelForXP(c.playerXP[5]) / 4);
