...
import org.osps.model.npcs.boss.instances.impl.SingleInstancedZulrah;
import org.osps.model.npcs.boss.zulrah.impl.CreateToxicStageOne;
import org.osps.model.npcs.boss.zulrah.impl.MageStageEight;
import org.osps.model.npcs.boss.zulrah.impl.MageStageFive;
import org.osps.model.npcs.boss.zulrah.impl.MageStageThree;
import org.osps.model.npcs.boss.zulrah.impl.MeleeStageSix;
import org.osps.model.npcs.boss.zulrah.impl.MeleeStageTen;
import org.osps.model.npcs.boss.zulrah.impl.MeleeStageTwo;
import org.osps.model.npcs.boss.zulrah.impl.RangeStageEleven;
import org.osps.model.npcs.boss.zulrah.impl.RangeStageFour;
import org.osps.model.npcs.boss.zulrah.impl.RangeStageNine;
import org.osps.model.npcs.boss.zulrah.impl.RangeStageSeven;
import org.osps.model.npcs.boss.zulrah.impl.SpawnZulrahStageZero;
	...
	public void stop() {
		...
		if (globalBest.getFirst() == null || globalBest.getSecond() == null || time < globalBest.getSecond() && globalBest.getSecond() != 0) {
			PlayerHandler.executeGlobalMessage("<img=10>[<col=255>Zulrah</col>] A new record has been set! <col=255>" + Misc.capitalize(player.playerName) 
					+ "</col> just killed Zulrah in <col=255> "+duration+"</col>.",false);
			if (globalBest.getFirst() != null && globalBest.getSecond() != null) {
				PlayerHandler.executeGlobalMessage("<img=10></img>[<col=255>Zulrah</col>] The old record was set by: <col=255>" + globalBest.getFirst()
						+ "</col>, with a time of: <col=255>"+Misc.toFormattedMS(globalBest.getSecond())+"</col>.",false);
			}
