package org.osps.model.minigames;
...
public class Barrows {
	...
	public static int[][] barrowData = {
		/**  ID   Coffin  X     Y   Stair   X      Y */
			...
			{1677, 20772, 3575, 9706, 20672, 3557, 3297}, /**Veracs*/ // 20672
			{1672, 20770, 3557, 9700, 20667, 3565, 3288}, /**Ahrims*/
			{1676, 20721, 3568, 9685, 20671, 3554, 3282}, /**Torags*/ // 20671
...
//		c.getItems().addItem(995,  Misc.random(5000,10000));
		...
		c.getItems().addItem(2996, Misc.random(100, 100));
		c.sendMessage("You recieve a random barrows piece and 100 pkp tickets for your efforts.");
		if (c.inBarrows()) {
